...
const Auth = () => {
  ...
  return (
    <div id="login-form" className="container mx-auto flex justify-center items-center h-screen">
      <form
      ...
      >
        ...
        <button
          className="w-full bg-[#222] text-white rounded-lg py-3 hover:bg-[#a13333] transition duration-200"
        >
          Login
        </button>
      </form>
